...
$posttestsql = "SELECT * FROM fitness_test WHERE student_id = '$studentID' AND `test-type` = 'post-test' AND 
`date-taken` = (SELECT MAX(`date-taken`) FROM fitness_test WHERE student_id = '$studentID' AND `test-type` = 'post-test')";
...
$studentName = "SELECT * FROM student WHERE student_id = '$studentID'";
